  ...
  return (0, import_jsx_runtime19.jsxs)(React20.Fragment, {
    children: [(0, import_jsx_runtime19.jsx)(SelectSelect, {
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span4 || (_span4 = (0, import_jsx_runtime19.jsx)("span", {
          className: "notranslate",
          "aria-hidden": true,
          children: "​"
        }))
...
var Tab = React23.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React23.isValidElement(iconProp) ? React23.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime22.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime22.jsxs)(React23.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime22.jsxs)(React23.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
//# sourceMappingURL=chunk-M53TUWSU.js.map
