        ...
        if response.status_code == 200:
            ...
            try:
                ...
                if hasattr(user, "employee") and user.employee:
                    ...
                    print("Server timezone now:", timezone.now())
                    print("Attendance object:", attendance_today)
                    if attendance_today:
                        print("Attendance.date:", attendance_today.date)
                        print("Attendance.login_time:", attendance_today.login_time)
                        print("Attendance.status:", attendance_today.status)
                    print("============================")
